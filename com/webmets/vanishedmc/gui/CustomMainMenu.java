...
public class CustomMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(new GuiButton(0, this.width / 2 - 100, p_73969_1_ + 72 + 12, 98, 20,
				I18n.format("menu.options", new Object[0])));
		this.buttonList.add(
				new GuiButton(4, this.width / 2 + 2, p_73969_1_ + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
		this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, p_73969_1_ + 72 + 12));
	}
